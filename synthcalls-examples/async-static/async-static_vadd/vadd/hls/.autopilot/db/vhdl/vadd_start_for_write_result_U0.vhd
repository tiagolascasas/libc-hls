...
entity vadd_start_for_write_result_U0 is 
    generic (
...
architecture rtl of vadd_start_for_write_result_U0 is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component vadd_start_for_write_result_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
...
begin
----------------------- Instantiation -----------------------
    U_vadd_start_for_write_result_U0_ShiftReg : vadd_start_for_write_result_U0_ShiftReg
    generic map (
...
entity vadd_start_for_write_result_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end vadd_start_for_write_result_U0_ShiftReg;

architecture rtl of vadd_start_for_write_result_U0_ShiftReg is
