...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { inStream2_din { O 32 vector } inStream2_num_data_valid { I 3 vector } inStream2_fifo_cap { I 3 vector } inStream2_full_n { I 1 bit } inStream2_write { O 1 bit } } \
} "
}
...
set InstName vadd_flow_control_loop_pipe_U
set CompName vadd_flow_control_loop_pipe
