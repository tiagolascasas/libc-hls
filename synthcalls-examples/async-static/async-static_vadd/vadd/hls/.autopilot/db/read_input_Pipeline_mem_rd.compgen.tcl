...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { inStream1_din { O 32 vector } inStream1_num_data_valid { I 3 vector } inStream1_fifo_cap { I 3 vector } inStream1_full_n { I 1 bit } inStream1_write { O 1 bit } } \
} "
}
...
set InstName vadd_flow_control_loop_pipe_sequential_init_U
set CompName vadd_flow_control_loop_pipe_sequential_init
