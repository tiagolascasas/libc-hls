...
set Spec2ImplPortList { 
	...
	inStream2 { ap_fifo {  { inStream2_din fifo_data_in 1 32 }  { inStream2_num_data_valid fifo_status_num_data_valid 0 3 }  { inStream2_fifo_cap fifo_update 0 3 }  { inStream2_full_n fifo_status 0 1 }  { inStream2_write fifo_port_we 1 1 } } }
}
