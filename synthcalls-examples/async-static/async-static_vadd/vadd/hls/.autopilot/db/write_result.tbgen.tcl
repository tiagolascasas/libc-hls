...
set portList { 
	...
	{ size_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ size_fifo_cap sc_in sc_lv 3 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_result_Pipeline_mem_wr_fu_73", "Port" : "gmem0", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			...
			{"Name" : "outStream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_result_Pipeline_mem_wr_fu_73", "Port" : "outStream", "Inst_start_state" : "3", "Inst_end_state" : "4"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_write_result_Pipeline_mem_wr_fu_73", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_result_Pipeline_mem_wr_fu_73.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	outStream { ap_fifo {  { outStream_dout fifo_data_in 0 32 }  { outStream_num_data_valid fifo_status_num_data_valid 0 3 }  { outStream_fifo_cap fifo_update 0 3 }  { outStream_empty_n fifo_status 0 1 }  { outStream_read fifo_port_we 1 1 } } }
}
