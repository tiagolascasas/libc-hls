...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "8", "10", "13", "16", "17", "18", "19", "20", "21", "22", "23"],
		"CDFG" : "vadd",
		...
		"InputProcess" : [
			...
			{"ID" : "8", "Name" : "read_input_1_U0"}],
		"OutputProcess" : [
			{"ID" : "13", "Name" : "write_result_U0"}],
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "13", "SubInstance" : "write_result_U0", "Port" : "gmem0"},
					{"ID" : "5", "SubInstance" : "read_input_U0", "Port" : "gmem0"}]},
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "read_input_1_U0", "Port" : "gmem1"}]},
			{"Name" : "in1", "Type" : "None", "Direction" : "I"},
			{"Name" : "in2", "Type" : "None", "Direction" : "I"},
			{"Name" : "out_r", "Type" : "None", "Direction" : "I"},
			{"Name" : "size", "Type" : "None", "Direction" : "I"},
			{"Name" : "inStream1", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "compute_add_U0", "Port" : "inStream1"},
					{"ID" : "5", "SubInstance" : "read_input_U0", "Port" : "inStream1"}]},
			{"Name" : "inStream2", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "compute_add_U0", "Port" : "inStream2"},
					{"ID" : "8", "SubInstance" : "read_input_1_U0", "Port" : "inStream2"}]},
			{"Name" : "outStream", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "compute_add_U0", "Port" : "outStream"},
					{"ID" : "13", "SubInstance" : "write_result_U0", "Port" : "outStream"}]}]},
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.read_input_U0", "Parent" : "0", "Child" : ["6"],
		...
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "grp_read_input_Pipeline_mem_rd_fu_82", "Port" : "gmem0", "Inst_start_state" : "73", "Inst_end_state" : "74"}]},
			{"Name" : "in_r", "Type" : "None", "Direction" : "I"},
			{"Name" : "size", "Type" : "None", "Direction" : "I"},
			{"Name" : "size_c1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["10"], "DependentChan" : "17", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "size_c1_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "inStream1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["10"], "DependentChan" : "18", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "grp_read_input_Pipeline_mem_rd_fu_82", "Port" : "inStream1", "Inst_start_state" : "73", "Inst_end_state" : "74"}]}]},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.read_input_U0.grp_read_input_Pipeline_mem_rd_fu_82", "Parent" : "5", "Child" : ["7"],
		...
		"Port" : [
			...
			{"Name" : "inStream1", "Type" : "Fifo", "Direction" : "O",
				"BlockSignal" : [
	...
	{"ID" : "7", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.read_input_U0.grp_read_input_Pipeline_mem_rd_fu_82.flow_control_loop_pipe_sequential_init_U", "Parent" : "6"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.read_input_1_U0", "Parent" : "0", "Child" : ["9"],
		"CDFG" : "read_input_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "in_r", "Type" : "None", "Direction" : "I"},
			{"Name" : "size", "Type" : "None", "Direction" : "I"},
			{"Name" : "inStream2", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["10"], "DependentChan" : "19", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.read_input_1_U0.flow_control_loop_pipe_U", "Parent" : "8"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.compute_add_U0", "Parent" : "0", "Child" : ["11"],
		"CDFG" : "compute_add",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "size", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["5"], "DependentChan" : "17", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "size_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "size_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["13"], "DependentChan" : "20", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "size_c_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "inStream1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["5"], "DependentChan" : "18", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "grp_compute_add_Pipeline_execute_fu_52", "Port" : "inStream1", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "inStream2", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["8"], "DependentChan" : "19", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "grp_compute_add_Pipeline_execute_fu_52", "Port" : "inStream2", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "outStream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["13"], "DependentChan" : "21", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "grp_compute_add_Pipeline_execute_fu_52", "Port" : "outStream", "Inst_start_state" : "2", "Inst_end_state" : "3"}]}]},
	{"ID" : "11", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.compute_add_U0.grp_compute_add_Pipeline_execute_fu_52", "Parent" : "10", "Child" : ["12"],
	...
	{"ID" : "12", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.compute_add_U0.grp_compute_add_Pipeline_execute_fu_52.flow_control_loop_pipe_sequential_init_U", "Parent" : "11"},
	{"ID" : "13", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.write_result_U0", "Parent" : "0", "Child" : ["14"],
		"CDFG" : "write_result",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "14", "SubInstance" : "grp_write_result_Pipeline_mem_wr_fu_73", "Port" : "gmem0", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "out_r", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["4"], "DependentChan" : "16", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "out_r_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "size", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["10"], "DependentChan" : "20", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "size_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "outStream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["10"], "DependentChan" : "21", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "14", "SubInstance" : "grp_write_result_Pipeline_mem_wr_fu_73", "Port" : "outStream", "Inst_start_state" : "3", "Inst_end_state" : "4"}]}]},
	{"ID" : "14", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.write_result_U0.grp_write_result_Pipeline_mem_wr_fu_73", "Parent" : "13", "Child" : ["15"],
		"CDFG" : "write_result_Pipeline_mem_wr",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		...
		"Loop" : [
			{"Name" : "mem_wr", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter2", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter2", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "15", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.write_result_U0.grp_write_result_Pipeline_mem_wr_fu_73.flow_control_loop_pipe_sequential_init_U", "Parent" : "14"},
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.out_r_c_U", "Parent" : "0"},
	{"ID" : "17", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.size_c1_U", "Parent" : "0"},
	{"ID" : "18", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.inStream1_U", "Parent" : "0"},
	{"ID" : "19", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.inStream2_U", "Parent" : "0"},
	{"ID" : "20", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.size_c_U", "Parent" : "0"},
	{"ID" : "21", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.outStream_U", "Parent" : "0"},
	{"ID" : "22", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_write_result_U0_U", "Parent" : "0"},
	{"ID" : "23", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_compute_add_U0_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	vadd {
		...
		inStream1 {Type IO LastRead -1 FirstWrite -1}
		inStream2 {Type IO LastRead -1 FirstWrite -1}
	...
	read_input {
		...
		size {Type I LastRead 0 FirstWrite -1}
		size_c1 {Type O LastRead -1 FirstWrite 0}
		inStream1 {Type O LastRead -1 FirstWrite 2}}
