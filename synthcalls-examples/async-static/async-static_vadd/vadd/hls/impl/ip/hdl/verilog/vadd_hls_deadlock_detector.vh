...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    vadd_hls_deadlock_detect_unit #(5, 0, 3, 3) vadd_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_start_FIFO_blk[0] = 1'b0 | (~start_for_write_result_U0_U.if_full_n & entry_proc_U0.ap_start & ~entry_proc_U0.real_start & (trans_in_cnt_1 == trans_out_cnt_1) & ~start_for_write_result_U0_U.if_read);
    ...
    assign proc_0_input_sync_blk[2] = 1'b0 | (ap_sync_entry_proc_U0_ap_ready & entry_proc_U0.ap_idle & ~ap_sync_read_input_1_U0_ap_ready);
    ...
    vadd_hls_deadlock_detect_unit #(5, 1, 3, 3) vadd_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~read_input_U0.size_c1_blk_n) | (~read_input_U0.grp_read_input_Pipeline_mem_rd_fu_82.inStream1_blk_n);
    assign proc_1_data_PIPO_blk[0] = 1'b0;
    assign proc_1_start_FIFO_blk[0] = 1'b0 | (~start_for_compute_add_U0_U.if_full_n & read_input_U0.ap_start & ~read_input_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_compute_add_U0_U.if_read);
    ...
    assign proc_1_input_sync_blk[2] = 1'b0 | (ap_sync_read_input_U0_ap_ready & read_input_U0.ap_idle & ~ap_sync_read_input_1_U0_ap_ready);
    ...
    // Process: read_input_1_U0
    vadd_hls_deadlock_detect_unit #(5, 2, 3, 3) vadd_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~read_input_1_U0.inStream2_blk_n);
    ...
    assign proc_2_input_sync_blk[1] = 1'b0 | (ap_sync_read_input_1_U0_ap_ready & read_input_1_U0.ap_idle & ~ap_sync_entry_proc_U0_ap_ready);
    ...
    assign proc_2_input_sync_blk[2] = 1'b0 | (ap_sync_read_input_1_U0_ap_ready & read_input_1_U0.ap_idle & ~ap_sync_read_input_U0_ap_ready);
    ...
    vadd_hls_deadlock_detect_unit #(5, 3, 3, 3) vadd_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~compute_add_U0.size_blk_n) | (~compute_add_U0.grp_compute_add_Pipeline_execute_fu_52.inStream1_blk_n);
    ...
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~compute_add_U0.size_c_blk_n) | (~compute_add_U0.grp_compute_add_Pipeline_execute_fu_52.outStream_blk_n);
    ...
    assign proc_3_data_FIFO_blk[2] = 1'b0 | (~compute_add_U0.grp_compute_add_Pipeline_execute_fu_52.inStream2_blk_n);
    ...
    vadd_hls_deadlock_detect_unit #(5, 4, 2, 2) vadd_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~write_result_U0.out_r_blk_n);
    assign proc_4_data_PIPO_blk[0] = 1'b0;
    assign proc_4_start_FIFO_blk[0] = 1'b0 | (~start_for_write_result_U0_U.if_empty_n & write_result_U0.ap_idle & ~start_for_write_result_U0_U.if_write);
    assign proc_4_TLF_FIFO_blk[0] = 1'b0;
    assign proc_4_input_sync_blk[0] = 1'b0;
    assign proc_4_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_4[0] = dl_detect_out ? proc_dep_vld_vec_4_reg[0] : (proc_4_data_FIFO_blk[0] | proc_4_data_PIPO_blk[0] | proc_4_start_FIFO_blk[0] | proc_4_TLF_FIFO_blk[0] | proc_4_input_sync_blk[0] | proc_4_output_sync_blk[0]);
    assign proc_4_data_FIFO_blk[1] = 1'b0 | (~write_result_U0.size_blk_n) | (~write_result_U0.grp_write_result_Pipeline_mem_wr_fu_73.outStream_blk_n);
...
`include "vadd_hls_deadlock_report_unit.vh"
