...
entity vadd_read_input_Pipeline_mem_rd is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of vadd_read_input_Pipeline_mem_rd is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln68_fu_96_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal gmem0_addr_read_reg_135 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_fu_52 : STD_LOGIC_VECTOR (30 downto 0) := "0000000000000000000000000000000";
    signal add_ln68_fu_102_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_load : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal inStream1_write_local : STD_LOGIC;
    signal zext_ln68_fu_92_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln68_fu_96_p2 = ap_const_lv1_1))) then 
    ...
    add_ln68_fu_102_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_load) + unsigned(ap_const_lv31_1));
    ...
    ap_block_state3_pp0_stage0_iter2_assign_proc : process(inStream1_full_n)
    begin
                ap_block_state3_pp0_stage0_iter2 <= (inStream1_full_n = ap_const_logic_0);
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln68_fu_96_p2)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln68_fu_96_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    icmp_ln68_fu_96_p2 <= "1" when (signed(zext_ln68_fu_92_p1) < signed(size)) else "0";

    inStream1_blk_n_assign_proc : process(ap_enable_reg_pp0_iter2, inStream1_full_n, ap_block_pp0_stage0)
    begin
    ...
    inStream1_din <= gmem0_addr_read_reg_135;
    inStream1_write <= inStream1_write_local;

    inStream1_write_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            inStream1_write_local <= ap_const_logic_1;
        else 
            inStream1_write_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    zext_ln68_fu_92_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_load),32));
end behav;
