...
architecture behav of vadd_read_input is 
...
attribute shreg_extract : string;
    ...
    signal empty_fu_102_p3 : STD_LOGIC_VECTOR (30 downto 0);
    signal empty_reg_140 : STD_LOGIC_VECTOR (30 downto 0);
    signal trunc_ln68_2_fu_110_p4 : STD_LOGIC_VECTOR (61 downto 0);
    signal trunc_ln68_2_reg_145 : STD_LOGIC_VECTOR (61 downto 0);
    signal zext_ln68_fu_131_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_ap_start : STD_LOGIC;
    signal grp_read_input_Pipeline_mem_rd_fu_82_ap_done : STD_LOGIC;
    signal grp_read_input_Pipeline_mem_rd_fu_82_ap_idle : STD_LOGIC;
    signal grp_read_input_Pipeline_mem_rd_fu_82_ap_ready : STD_LOGIC;
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_AWVALID : STD_LOGIC;
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_AWADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_AWID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_AWLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_AWSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_AWBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_AWLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_AWCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_AWPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_AWQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_AWREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_AWUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_WVALID : STD_LOGIC;
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_WDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_WSTRB : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_WLAST : STD_LOGIC;
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_WID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_WUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARVALID : STD_LOGIC;
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_RREADY : STD_LOGIC;
    signal grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_BREADY : STD_LOGIC;
    signal grp_read_input_Pipeline_mem_rd_fu_82_inStream1_din : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_read_input_Pipeline_mem_rd_fu_82_inStream1_write : STD_LOGIC;
    signal grp_read_input_Pipeline_mem_rd_fu_82_ap_ext_blocking_n : STD_LOGIC;
    signal grp_read_input_Pipeline_mem_rd_fu_82_ap_str_blocking_n : STD_LOGIC;
    signal grp_read_input_Pipeline_mem_rd_fu_82_ap_int_blocking_n : STD_LOGIC;
    signal grp_read_input_Pipeline_mem_rd_fu_82_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state73 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state73 : signal is "none";
    signal ap_CS_fsm_state74 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state74 : signal is "none";
    signal sext_ln68_fu_120_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal size_c1_write_local : STD_LOGIC;
    signal icmp_ln68_fu_92_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln68_fu_98_p1 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    component vadd_read_input_Pipeline_mem_rd IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_read_input_Pipeline_mem_rd_fu_82 : component vadd_read_input_Pipeline_mem_rd
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((grp_read_input_Pipeline_mem_rd_fu_82_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state74))) then 
    ...
    grp_read_input_Pipeline_mem_rd_fu_82_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_read_input_Pipeline_mem_rd_fu_82_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state73)) then 
                    grp_read_input_Pipeline_mem_rd_fu_82_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_read_input_Pipeline_mem_rd_fu_82_ap_ready = ap_const_logic_1)) then 
                    grp_read_input_Pipeline_mem_rd_fu_82_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem0_ARREADY = ap_const_logic_1))) then
                trunc_ln68_2_reg_145 <= in_r(63 downto 2);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem0_ARREADY, ap_CS_fsm_state2, ap_block_state1, grp_read_input_Pipeline_mem_rd_fu_82_ap_done, ap_CS_fsm_state74)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state74 => 
                if (((grp_read_input_Pipeline_mem_rd_fu_82_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state74))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state74;
                end if;
    ...
    ap_ST_fsm_state74_blk_assign_proc : process(grp_read_input_Pipeline_mem_rd_fu_82_ap_done)
    begin
        if ((grp_read_input_Pipeline_mem_rd_fu_82_ap_done = ap_const_logic_0)) then 
    ...
    ap_done_assign_proc : process(ap_done_reg, grp_read_input_Pipeline_mem_rd_fu_82_ap_done, ap_CS_fsm_state74)
    begin
        if (((grp_read_input_Pipeline_mem_rd_fu_82_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state74))) then 
    ...
    ap_int_blocking_cur_n <= (size_c1_blk_n);
    ...
    ap_sub_ext_blocking_0_assign_proc : process(grp_read_input_Pipeline_mem_rd_fu_82_ap_ext_blocking_n)
    begin
        if ((grp_read_input_Pipeline_mem_rd_fu_82_ap_ext_blocking_n = ap_const_logic_0)) then 
    ...
    ap_sub_int_blocking_0_assign_proc : process(grp_read_input_Pipeline_mem_rd_fu_82_ap_int_blocking_n)
    begin
        if ((grp_read_input_Pipeline_mem_rd_fu_82_ap_int_blocking_n = ap_const_logic_0)) then 
    ...
    ap_sub_str_blocking_0_assign_proc : process(grp_read_input_Pipeline_mem_rd_fu_82_ap_str_blocking_n)
    begin
        if ((grp_read_input_Pipeline_mem_rd_fu_82_ap_str_blocking_n = ap_const_logic_0)) then 
    ...
    empty_fu_102_p3 <= 
        trunc_ln68_fu_98_p1 when (icmp_ln68_fu_92_p2(0) = '1') else 
        ap_const_lv31_0;
    ...
    grp_read_input_Pipeline_mem_rd_fu_82_ap_start <= grp_read_input_Pipeline_mem_rd_fu_82_ap_start_reg;
    icmp_ln68_fu_92_p2 <= "1" when (signed(size) > signed(ap_const_lv32_0)) else "0";
    inStream1_din <= grp_read_input_Pipeline_mem_rd_fu_82_inStream1_din;

    inStream1_write_assign_proc : process(grp_read_input_Pipeline_mem_rd_fu_82_inStream1_write, ap_CS_fsm_state74)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state74)) then 
            inStream1_write <= grp_read_input_Pipeline_mem_rd_fu_82_inStream1_write;
        else 
            inStream1_write <= ap_const_logic_0;
        end if; 
    end process;


    internal_ap_ready_assign_proc : process(grp_read_input_Pipeline_mem_rd_fu_82_ap_done, ap_CS_fsm_state74)
    begin
        if (((grp_read_input_Pipeline_mem_rd_fu_82_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state74))) then 
    ...
    m_axi_gmem0_ARADDR_assign_proc : process(m_axi_gmem0_ARREADY, ap_CS_fsm_state2, grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARADDR, ap_CS_fsm_state73, ap_CS_fsm_state74, sext_ln68_fu_120_p1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem0_ARREADY = ap_const_logic_1))) then 
    ...
    m_axi_gmem0_ARBURST_assign_proc : process(grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARBURST, ap_CS_fsm_state73, ap_CS_fsm_state74)
    begin
    ...
    m_axi_gmem0_ARCACHE_assign_proc : process(grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARCACHE, ap_CS_fsm_state73, ap_CS_fsm_state74)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state74) or (ap_const_logic_1 = ap_CS_fsm_state73))) then 
            m_axi_gmem0_ARCACHE <= grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARCACHE;
        else 
    ...
    m_axi_gmem0_ARID_assign_proc : process(grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARID, ap_CS_fsm_state73, ap_CS_fsm_state74)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state74) or (ap_const_logic_1 = ap_CS_fsm_state73))) then 
            m_axi_gmem0_ARID <= grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARID;
        else 
    ...
    m_axi_gmem0_ARLEN_assign_proc : process(m_axi_gmem0_ARREADY, ap_CS_fsm_state2, zext_ln68_fu_131_p1, grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARLEN, ap_CS_fsm_state73, ap_CS_fsm_state74)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem0_ARREADY = ap_const_logic_1))) then 
            m_axi_gmem0_ARLEN <= zext_ln68_fu_131_p1(32 - 1 downto 0);
        elsif (((ap_const_logic_1 = ap_CS_fsm_state74) or (ap_const_logic_1 = ap_CS_fsm_state73))) then 
            m_axi_gmem0_ARLEN <= grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARLEN;
        else 
    ...
    m_axi_gmem0_ARLOCK_assign_proc : process(grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARLOCK, ap_CS_fsm_state73, ap_CS_fsm_state74)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state74) or (ap_const_logic_1 = ap_CS_fsm_state73))) then 
            m_axi_gmem0_ARLOCK <= grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARLOCK;
        else 
    ...
    m_axi_gmem0_ARPROT_assign_proc : process(grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARPROT, ap_CS_fsm_state73, ap_CS_fsm_state74)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state74) or (ap_const_logic_1 = ap_CS_fsm_state73))) then 
            m_axi_gmem0_ARPROT <= grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARPROT;
        else 
    ...
    m_axi_gmem0_ARQOS_assign_proc : process(grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARQOS, ap_CS_fsm_state73, ap_CS_fsm_state74)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state74) or (ap_const_logic_1 = ap_CS_fsm_state73))) then 
            m_axi_gmem0_ARQOS <= grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARQOS;
        else 
    ...
    m_axi_gmem0_ARREGION_assign_proc : process(grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARREGION, ap_CS_fsm_state73, ap_CS_fsm_state74)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state74) or (ap_const_logic_1 = ap_CS_fsm_state73))) then 
            m_axi_gmem0_ARREGION <= grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARREGION;
        else 
    ...
    m_axi_gmem0_ARSIZE_assign_proc : process(grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARSIZE, ap_CS_fsm_state73, ap_CS_fsm_state74)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state74) or (ap_const_logic_1 = ap_CS_fsm_state73))) then 
            m_axi_gmem0_ARSIZE <= grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARSIZE;
        else 
    ...
    m_axi_gmem0_ARUSER_assign_proc : process(grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARUSER, ap_CS_fsm_state73, ap_CS_fsm_state74)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state74) or (ap_const_logic_1 = ap_CS_fsm_state73))) then 
            m_axi_gmem0_ARUSER <= grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARUSER;
        else 
    ...
    m_axi_gmem0_ARVALID_assign_proc : process(m_axi_gmem0_ARREADY, ap_CS_fsm_state2, grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARVALID, ap_CS_fsm_state73, ap_CS_fsm_state74)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem0_ARREADY = ap_const_logic_1))) then 
    ...
    m_axi_gmem0_RREADY_assign_proc : process(grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_RREADY, ap_CS_fsm_state73, ap_CS_fsm_state74)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state74) or (ap_const_logic_1 = ap_CS_fsm_state73))) then 
            m_axi_gmem0_RREADY <= grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_RREADY;
        else 
    ...
    begin
        ...
        sext_ln68_fu_120_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln68_2_fu_110_p4),64));
    ...
    size_c1_din <= size;
    size_c1_write <= size_c1_write_local;

    size_c1_write_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
            size_c1_write_local <= ap_const_logic_1;
        else 
            size_c1_write_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    trunc_ln68_2_fu_110_p4 <= in_r(63 downto 2);
    trunc_ln68_fu_98_p1 <= size(31 - 1 downto 0);
    zext_ln68_fu_131_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_reg_140),64));
end behav;
